...
Welcome to the R, Open Research, and Reproducibility for Psychology set of workshops. My name is Andrew Stewart and I'm an Experimental Psychologist in the Division of Neuroscience and Experimental Psychology at the University of Manchester. You can contact me via [email](mailto:drandrewjstewart@gmail.com) or via direct message on [Twitter](https://twitter.com/ajstewart_lang). If you are interested in my academic interests, you can check out my website [here](https://ajstewartlang.netlify.app/).
